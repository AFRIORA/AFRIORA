/* =========================================================
   ...
   - This file uses the publishable client key only.
========================================================= */
...
function updateCountry(countryData) {
    ...
    if (selectedCountry) {
        ...
        selectedCountry.style.display =
            "flex";
    }

    if (identityGroup) {
        identityGroup.hidden =
            false;

        identityGroup.style.display =
            "block";
    }
    ...
    if (documentTypeBox) {
        documentTypeBox.hidden =
            false;

        documentTypeBox.style.display =
            "block";
    }
...
function renderCountryResults(searchValue = "") {
    ...
    countryResults.hidden =
        false;

    countryResults.style.display =
        "block";
...
if (countrySearch) {
    ...
    countrySearch.addEventListener(
        ...
        function () {
            ...
            /*
             * The user changed the displayed country text.
             * Clear the previous hidden selection so an old
             * country cannot accidentally be submitted.
             */
...
/* =========================================================
   ...
   ---------------------------------------------------------
   Sensitive values are deliberately excluded.
========================================================= */
...
function saveRegistrationContext(registration) {
    ...
    /*
     * NEVER put these into this object:
     *
     * - password
     * - confirmPassword
     * - identityNumber
    ...
    registerForm.addEventListener(
        ...
        async function (event) {
            ...
            try {
                 ...
                 * there may be no authenticated session yet.
                 *
                 * The profile should be saved AFTER OTP
                 * verification on otp.html.
                 */
...
/* =========================================================
   ...
   ---------------------------------------------------------
   CALL THIS FROM otp.html AFTER OTP VERIFICATION.

   IMPORTANT:
   - Password is not saved.
   - Identity number is not saved.
   - This should run only after the user has been
